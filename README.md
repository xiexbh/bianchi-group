...
- `d5.txt` : Magma script for $\Gamma_5 = \mathrm{PSL}(2, \mathcal{O}_5)$
- `d6.txt` : Magma script for $\Gamma_6 = \mathrm{PSL}(2, \mathcal{O}_6)$
- `d6-relation.txt` : All relations obtained from our method for $\Gamma_6$
